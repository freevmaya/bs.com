...
def combine_project_files():
    ...
    exclude_paths = ["vendor", "dev", "prepare", "assets"]
...
Не меняй дизайн и/или CSS стили, если не было прямого указания для этого.
Стили размещать в файле стилей (CSS).
Скрипты размещать в файлах скриптов (JS).
